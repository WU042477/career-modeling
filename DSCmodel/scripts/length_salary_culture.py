...
plt.scatter(df["text_length"], df["salary_avg"], alpha=0.6, color='teal', edgecolor='k')
plt.title("Word Count of Job Description vs. Average Salary", fontsize=16)
plt.xlabel("Word Count", fontsize=12)
plt.ylabel("Average Salary (CNY/month)", fontsize=12)
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
output_path = r"D:\Users\WU\Desktop\DSCmodel\output\job_length_vs_salary.png"
