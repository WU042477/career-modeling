...
majors = {
    "Computer Science": [
        "algorithm", "python", "data", "network", "system",
        "software", "coding", "machine", "AI", "model"
    ],
    "Education": [
        "teaching", "classroom", "student", "curriculum",
        "lesson", "training", "pedagogy", "education", "school"
    ],
    "Media": [
        "content", "video", "script", "publicity",
        "promotion", "platform", "media", "design", "operation"
    ],
    "Electrical Engineering": [
        "automation", "circuit", "control", "embedded",
        "signal", "hardware", "sensor", "PLC", "electrical"
    ]
}
